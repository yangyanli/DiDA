...
class Di_iter_DSN_Model(BaseModel):
    def name(self):
        return 'Di_iter_DSN_Model'
    ...
    def initialize(self, opt):
        ...
        self.netDe = networks.define_De(opt.output_nc, opt.input_nc, opt.which_model_netDe, opt.norm, not opt.no_dropout, opt.init_type, self.gpu_ids)
